...
public class Journal {
    ...
    public static void signIn() throws Exception {
        ...
        do{
            ...
            Scanner fileIn2 = new Scanner(new File("pw.txt"));
            ...
            if (!found){
                System.out.println("Le nom d'utilisateur n'existe pas. Essaye encore...");
            }
        } while ( !found );
        ...
        do {
            ...
            String givenPW = bytesToHex2.toString();

            
            if (givenPW.equals(filePW)){
                found = true;
                welcome();
                menu();
            }
    ...
    private static void journalRead() throws Exception{
        ...
        try {
            fileIn = new Scanner(new File(userJournal));
            
        } catch (java.io.IOException e) {
            System.err.println("\nVotre journal n'existe pas...");
            System.err.println("S'il vous plait ecrire dans votre journal avant de le lire.\n");
            menu();
            System.exit(1);
    ...
    public static void readOnlyOne() throws Exception{
        ...
        try {
            readEntry = new Scanner(new File(userJournal));
